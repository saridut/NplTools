!! Analysis routines for calculating the in-plane distribution of atoms of ligands 
!! grafted on nanoplatelets perpendicular to the NPL.

module rdf_calculator_m
...
type rdf_calculator_t
    ...
    contains
        procedure :: init => rdfc_init
        procedure :: delete => rdfc_delete
        procedure :: writeout => rdfc_writeout
        procedure :: process_frame => rdfc_process_frame
end type rdf_calculator_t

contains

!*******************************************************************************

subroutine rdfc_init(this, atc)

    class(rdf_calculator_t), intent(out) :: this
    ...
    num_bins = ceiling(this%rmax/this%bin_size)
    !Fix bin_size to make all bins equispaced
    this%bin_size = this%rmax/num_bins 
...
subroutine rdfc_delete(this)

    class(rdf_calculator_t), intent(in out) :: this
